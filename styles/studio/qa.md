...
Check that the image is a photorealistic studio portrait rather than an illustration or cartoon.

Approve when:
- the render reads as a professional studio photograph
- lighting and skin texture are natural and cohesive
- the subject looks like a real person captured on camera

Reject when:
- it looks like a painting, illustration, or digital art
- it looks like a rough sketch, vector, or cel-shaded cartoon
...
- the expression is confident, calm, and approachable
